...
module.exports = {
    ...
    async execute(client, message, args, Discord) {
        if(!args[0]) return message.channel.send(new Discord.MessageEmbed() .setdescription('<a:srry:825769123686252545> please enter the amount of messages thet you want to clear') .setColor('RED'));
